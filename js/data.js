/* ============================================================
   ...
   Add your own via the Create a Brew tab, or edit this array directly.
   ============================================================ */

/* ---- BrewGenge Celtic crest logo (hand-built SVG, always renders) ---- */
...
/* ---- Ingredient prices (Brewman baseline, AUD, researched 8 Sep 2026) ---- */
const FERMENTABLE_PRICE = { default: 4.85 };
const HOP_PRICE = { default: 0.13 };

/* ---- The 10 built-in recipes, with full grain + hop bills ---- */
const RECIPES = [
...
/* ---- Suppliers (landed cost estimate, researched delivery terms) ---- */
const SUPPLIERS = [
